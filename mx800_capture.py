...
def build_assoc_request() -> bytes:
    inner = ASSOC_REQ_PRES_HEADER[2:] + ASSOC_REQ_USER_DATA + ASSOC_REQ_PRES_TRAILER
...
def run(monitor_ip: str, db_path: str, csv_dir: str, demo_json: str,
    ...
    def send_assoc():
        ...
        sock.sendto(build_assoc_request(), (monitor_ip, MX800_DATA_PORT))
        associated = False
